...
Let's take a quick look at our data to get a feel for what we're working with
...
plot(rpkm.pca$rotation[,1], rpkm.pca$rotation[,2], 
...
rm(gene.var, rpkm.pca, rpkm.top1000); gc()  # clean up workspace
```
...
## Order cells by "Psuedotime" (temporal-spatial variation): Monocle
