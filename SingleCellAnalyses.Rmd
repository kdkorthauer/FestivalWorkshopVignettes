...
```{r Color by dropuout, eval=TRUE, echo=TRUE}
...
Finally, we'll create a heatmap plot to visualize how the overall expression of the top 25 HVG is associated with the major cell classes.
...
heatmap(m/apply(m,1,max),zlim=c(0,1),labCol=NA, col=brewer.pal(180,"YlOrRd"),
